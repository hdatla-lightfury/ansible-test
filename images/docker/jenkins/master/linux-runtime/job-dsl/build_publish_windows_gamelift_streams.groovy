pipelineJob('BuildPublish-Windows-GameLiftStreams') {
    triggers {
    ...
    definition {
        cps {
            script('''
                ...
                import vars.BuildConstantsWindowsGameLiftStreams
                import modules.jenkins.JenkinsOperations
                def BUILD_CONFIG_VALUES = BuildConstantsWindowsGameLiftStreams.BUILD_CONFIG_VALUES
                def BUILD_CONFIG_VALUES_NIGHTLY = BuildConstantsWindowsGameLiftStreams.BUILD_CONFIG_VALUES_NIGHTLY
                def BUILD_TARGET_VALUES = BuildConstantsWindowsGameLiftStreams.BUILD_TARGET_VALUES
                def BUILD_TARGET_VALUES_NIGHTLY = BuildConstantsWindowsGameLiftStreams.BUILD_TARGET_VALUES_NIGHTLY
                def STREAMS = BuildConstantsWindowsGameLiftStreams.STREAMS
                def STREAMS_NIGHTLY = BuildConstantsWindowsGameLiftStreams.STREAMS_NIGHTLY
                ...
                pipeline {
                    ...
                    stages {
                        ...
                        stage("Build and Publish For Windows GameLift Streams") {
                            steps {
                                script {
                                            ...
                                            selectedBuildTargets.each { buildTarget ->
                                                ...
                                                branches[branchName] = {
                                                    ...
                                                    jenkinsOps.findLockAndRunOnFreeNode(node_label){
                                                        echo "Triggering Build Windows GameLift Streams for configuration: ${buildConfig} and target: ${buildTarget}"
                                                        build job: '/build-jobs/Build-Windows', parameters: [
                                                        ...
                                                        build job: '/publish-jobs/Publish-S3-Windows-GameLiftStreams', parameters: [
                                                            string(name: 'P4_STREAM', value: stream),
                                                            string(name: 'NODE_NAME', value: env.NODE_NAME)
                                                        ], wait: true
                                                    }
